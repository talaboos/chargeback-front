      ...
      <main className={styles.main}>
        <div className={styles.wrapper}>
          ...
          <div className={styles.content}>
            ...
            <ul>
              <li>
                Morbi non tortor sit amet lacus ultrices bibendum vehicula ut
                arcu.
              </li>
              <li>
                Aliquam sed velit finibus, dignissim mauris non, consequat erat.
              </li>
              <li>Ut euismod nunc non elementum molestie.</li>
              <li>Vestibulum non nulla id odio lacinia scelerisque.</li>
              <li>In pellentesque justo vel semper faucibus.</li>
            </ul>
            <p>
